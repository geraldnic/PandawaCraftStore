import { IonAvatar, IonBackButton, IonButtons, IonCard, IonCol, IonContent, IonGrid, IonHeader, IonPage, IonRow, IonTitle, IonToolbar } from "@ionic/react";
    ...
    return (
        <IonPage>
            ...
            <IonContent>
                ...
                <h1 className="greeting">Toko X!</h1>
